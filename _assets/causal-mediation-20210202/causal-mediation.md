---
title: "Causal Mediation: A Brief Overview"
output: 
  html_document: 
    keep_md: yes
---
...
![Example of mediation.](mediation1.png){width=50%} 
...
![Three examples of mediation.](mediation2.png){width=60%} 
...
![Total effect](totaleffect.png){width=40%}
...
![Direct effect](directeffect.png){width=40%}
...
![Indirect effect](indirecteffect.png){width=40%}
...
![Mediation with confounding](mediation3.png){width=50%}
...
![Linear mediation model (structural equation model): scenario 0](mediationlinear.png){width=50%}
...
![](causal-mediation_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
![Linear mediation model with confounding (structural equation model): scenario 1](mediationlinearconfounded.png){width=50%}
...
![](causal-mediation_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](causal-mediation_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
